...
The division of labor is worth keeping straight. `$deslop` removes slop from code, `$unslop` cleans prose, and `$no-comments` hands comments to a reviewer who didn't write them.
