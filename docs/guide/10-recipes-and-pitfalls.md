...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards above the counter.](./images/recipes.jpg)
...
- **A vague finish condition.** "make it better" gives a follow-up task nothing to check. Give a command or artifact that can pass or fail.
