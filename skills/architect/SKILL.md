...
Use your configured architect runners (defaults `gpt-6-astra` at max reasoning, `gpt-5.6-sol` at max reasoning, `gpt-5.6-luna` at xhigh reasoning, `gpt-5.6-terra` at xhigh reasoning).
