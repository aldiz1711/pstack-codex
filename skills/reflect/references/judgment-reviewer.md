...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.codex/skills/`, or plugin-installed paths under `~/.codex/plugins/`)
- Codex subagent prompts that name a skill path
