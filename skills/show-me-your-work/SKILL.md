...
At the end of the run, before handing back, check the log told the truth. Read this run's transcript from the current Codex task history or its task-reader tool, scoped to this task and workspace. Walk the log against what actually happened:
